...
const ManagingSidePanel = () => {
    ...
    return (
        <div className="bg-gray-200 p-4">
            <ul>
                <li className="mb-2">
                    <Link to={'/manage-infra'} className="block py-2 px-4 text-blue-900 font-semibold rounded hover:bg-gray-100">Infrastructure</Link>
                </li>
                <li className="mb-2">
...
export default ManagingSidePanel
